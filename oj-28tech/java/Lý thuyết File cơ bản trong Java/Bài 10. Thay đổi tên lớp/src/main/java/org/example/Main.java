...
public class Main {
    public static void main(String[] args) {
        ...
        updateClassName(updatedStudents, "IT1", "ITCLC1");
    ...
    private static void updateClassName(List<Student> students, String oldClassName, String newClassName) {
        for (Student student : students) {
            if (student.getClassName().equals(oldClassName)) {
